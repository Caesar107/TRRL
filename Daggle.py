...
bc_trainer = BC(
    ...
    batch_size=64,  # Batch size for supervised learning
...
with tempfile.TemporaryDirectory(prefix="dagger_example_") as tmpdir:
    ...
    total_steps = 10_00  # Total steps for training
    log_frequency = 1  # Log every 1000 steps

    for step in range(0, total_steps, log_frequency):
        dagger_trainer.train(total_timesteps=100, 
                             bc_train_kwargs={
            'n_batches': 10,  # 固定训练批次数量
